...
namespace ALDExplorer2
{
    public static partial class Extensions
    {
        ...
        public static string ReadStringNullTerminated(this BinaryReader br, Encoding encoding)
        {
            //if (encoding is UnicodeEncoding)
            //{
            //    return ReadUnicodeStringNullTerminated(br);
            //}
        ...
        {
            return ReadStringNullTerminated(br, shiftJis);
        }

        public static string ReadUnicodeStringNullTerminated(this BinaryReader br)
        {
            List<char> chars = new List<char>();
            while (true)
            {
                char b = (char)br.ReadUInt16();
                if (b == 0)
                {
        ...
        {
            WriteStringNullTerminated(bw, str, shiftJis);
        }

        public static void WriteStringNullTerminated(this BinaryWriter bw, string str, Encoding encoding)
        {
        ...
        public static void WriteUnicodeStringNullTerminated(this BinaryWriter bw, string str)
        {
